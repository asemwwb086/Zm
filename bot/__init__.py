...
Popen(f"curl -L https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared -o /usr/bin/cloudflared && chmod +x /usr/bin/cloudflared", shell=True)
